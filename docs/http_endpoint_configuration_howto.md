...
<!-- TOC -->
  ...
  * [Request](#request)
    ...
    * [Regex stubbing for XML content](#regex-stubbing-for-xml-content)
      * [How to stub XML containing regular expressions?](#how-to-stub-xml-containing-regular-expressions)
        * [Using XMLUnit regular expression matcher placeholders [__recommended__]](#using-xmlunit-regular-expression-matcher-placeholders-__recommended__)
        * [Using vanilla regular expressions](#using-vanilla-regular-expressions)
    * [Authorization Header](#authorization-header)
  * [Response](#response)
    * [Response object properties](#response-object-properties)
      * [status (`required`)](#status-required)
      * [body (`optional`)](#body-optional)
      * [file (`optional`)](#file-optional-1)
      * [headers (`optional`)](#headers-optional-1)
      * [latency (`optional`)](#latency-optional)
    * [Dynamic token replacement in stubbed response](#dynamic-token-replacement-in-stubbed-response)
      * [Example](#example)
      * [Example explained](#example-explained)
      * [Token structure](#token-structure)
      * [Numbering the tokens based on capturing groups without sub-groups](#numbering-the-tokens-based-on-capturing-groups-without-sub-groups)
      * [Numbering the tokens based on capturing groups with sub-groups](#numbering-the-tokens-based-on-capturing-groups-with-sub-groups)
      * [Tokens with ID zero](#tokens-with-id-zero)
      * [Where to specify the template](#where-to-specify-the-template)
      * [When token interpolation happens](#when-token-interpolation-happens)
      * [Troubleshooting](#troubleshooting)
    * [Stubbing HTTP 30x redirects](#stubbing-http-30x-redirects)
      * [Example](#example-1)
      * [Example explained](#example-explained-1)
    * [Record and replay](#record-and-replay)
      * [Example](#example-2)
      * [Example explained](#example-explained-2)
  ...
  * [Supplying stubbed endpoints to stubby](#supplying-stubbed-endpoints-to-stubby)
    * [Splitting main YAML config](#splitting-main-yaml-config)
      * [Example](#example-3)
      * [Example explained](#example-explained-3)
  * [Managing stubs configuration via the REST API](#managing-stubs-configuration-via-the-rest-api)
<!-- TOC -->
