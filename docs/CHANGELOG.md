...
* Completely revisited TLS configuration in stuby4j, which enables support for `TLSv1.0`, `TLSv1.1`, `TLSv1.2` and `TLSv1.3`. See [Making requests over TLS](../README.md#making-requests-over-tls) section 
