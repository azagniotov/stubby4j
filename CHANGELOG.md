#### 7.6.1-SNAPSHOT `master` branch

#### 7.6.0

* PR [#486](https://github.com/azagniotov/stubby4j/pull/486) - Bumped up SnakeYAML to v2.2 (https://github.com/azagniotov)
...
* Issue [#416](https://github.com/azagniotov/stubby4j/issues/416) - Upgrade log4j to `v2.16.0` - addressed critical CVEs found in `log4j2`: [CVE-2021-44228](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-44228) and [CVE-2021-45046](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-45046)
