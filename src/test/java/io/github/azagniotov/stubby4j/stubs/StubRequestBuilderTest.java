...
public class StubRequestBuilderTest {
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenNullUrlStubbed_AndNullUrlSubmitted() throws Exception {
        ...
        final StubRequest expectedRequest =
                builder.withUrl(null).withMethodGet().build();
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenNullUrlStubbed_ButUrlSubmitted() throws Exception {
        ...
        final StubRequest expectedRequest =
                builder.withUrl(null).withMethodGet().build();
        final StubRequest assertingRequest =
                builder.withUrl("invoice/123").withMethodGet().build();
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenRootUrlsEquals() throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl("/").withMethodGet().build();
        final StubRequest assertingRequest =
                builder.withUrl("/").withMethodGet().build();

        assertThat(assertingRequest).isEqualTo(expectedRequest);
    }

    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenStubbedRootUrlStartsWithRegex_ButSubmittedUrlRoot()
            throws Exception {
    ...
    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenStubbedUrlHasOptionalTrailingSlash_ButNoSlashSubmitted()
            throws Exception {
    ...
    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenStubbedUrlHasOptionalTrailingSlash_ButSlashSubmitted()
            throws Exception {
    ...
    @Test
    public void stubbedRequestNotEqualsAssertingRequest_WhenStubbedUrlHasRequiredTrailingSlash_ButNoSlashSubmitted()
            throws Exception {
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenStubbedUrlRegexBeginsWith() throws Exception {
        ...
        final StubRequest expectedRequest =
                builder.withUrl("^/invoice/123.*").withMethodGet().build();
        final StubRequest assertingRequest =
                builder.withUrl("/invoice/12345").withMethodGet().build();
    ...
    @Test
    public void stubbedRequestNotEqualsAssertingRequest_WhenStubbedUrlRegexBeginsWith_AndSubmittedUrlWrong()
            throws Exception {

        final StubRequest expectedRequest =
                builder.withUrl("^/invoice/123").withMethodGet().build();
        final StubRequest assertingRequest =
                builder.withUrl("/invoice/1").withMethodGet().build();
    ...
    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenStubbedUrlRegexEndsWith_AndSubmittedUrlHasExtraBeggining()
            throws Exception {

        final StubRequest expectedRequest =
                builder.withUrl(".*/invoice/123$").withMethodGet().build();
        final StubRequest assertingRequest =
                builder.withUrl("/some/beggining/invoice/123").withMethodGet().build();
    ...
    public void stubbedRequestNotEqualsAssertingRequest_WhenDifferentUri() throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url)
                .withMethodGet()
                .withMethodHead()
        ...
        final StubRequest assertingRequest = builder.withUrl("/invoice/788")
                .withMethodGet()
                .withMethodHead()
                .withQuery(paramTwo, paramTwoValue)
                .withQuery(paramOne, paramOneValue)
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenMethodStubbed_ButLowerCasedMethodSubmitted() throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url).withMethodGet().build();
        final StubRequest assertingRequest =
                builder.withUrl(url).withMethod("get").build();
    ...
    public void shouldAddMethod_WhenGivenMethodArgumentSet() throws Exception {
        ...
        final StubRequest expectedRequest =
                builder.withMethod("GET").withMethod("POST").withMethod("HEAD").build();
    ...
    public void shouldAddMethod_WhenGivenMethodArgumentEmpty() throws Exception {
        ...
        final StubRequest expectedRequest =
                builder.withMethod("GET").withMethod("").withMethod("HEAD").build();
    ...
    public void shouldAddMethod_WhenGivenMethodArgumentNull() throws Exception {
        ...
        final StubRequest expectedRequest =
                builder.withMethod("GET").withMethod(null).withMethod("HEAD").build();
    ...
    public void shouldGetPostBody_WhenPostProvided_ButFileIsNull() throws Exception {
        ...
        final StubRequest expectedRequest =
                builder.withUrl(url).withPost(postBody).withMethodPost().build();
    ...
    public void stubbedRequestNotEqualsAssertingRequest_WhenDifferentHttpMethod() throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url).withMethodGet().build();
        final StubRequest assertingRequest =
                builder.withUrl(url).withMethodPost().build();
    ...
    public void stubbedRequestNotEqualsAssertingRequest_WhenDifferentPostBody() throws Exception {
        ...
        final StubRequest expectedRequest =
                builder.withUrl(url).withMethodPost().withPost("some post").build();

        final StubRequest assertingRequest =
                builder.withUrl(url).withMethodPost().withPost("different post").build();

        assertThat(assertingRequest).isNotEqualTo(expectedRequest);
    }

    @Test
    public void stubbedRequestNotEqualsAssertingRequest_WhenPostBodyWasStubbed_ButNoPostBodySubmitted()
            throws Exception {
    ...
    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenNoPostBodyWasStubbed_ButPostBodyWasSubmitted()
            throws Exception {
    ...
    public void isSecured_WhenAuthorizationBasicStubbed() throws Exception {
        final StubRequest stubRequest = builder.withUrl("/invoice/123")
                .withMethodGet()
                .withHeader(BASIC.asYAMLProp(), "123")
                .build();
    ...
    public void isSecured_WhenAuthorizationBearerStubbed() throws Exception {
        final StubRequest stubRequest = builder.withUrl("/invoice/123")
                .withMethodGet()
                .withHeader(BEARER.asYAMLProp(), "123")
                .build();
    ...
    public void isSecured_WhenAuthorizationCustomStubbed() throws Exception {
        final StubRequest stubRequest = builder.withUrl("/invoice/123")
                .withMethodGet()
                .withHeader(CUSTOM.asYAMLProp(), "Custom 123")
                .build();
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenAllHttpHeadersMatch() throws Exception {
        ...
        final StubRequest assertingRequest = builder.withUrl(url)
                .withMethodGet()
                .withApplicationXmlContentType()
                .withHeaderContentLength(contentLength)
                .withHeaderContentLanguage(contentLanguage)
    ...
    @Test
    public void stubbedRequestNotEqualsAssertingRequest_WhenHeadersWereStubbed_ButNoHeadersSetToAssert()
            throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url)
                ...
                .withHeaderContentLanguage("en-US")
                .build();
    ...
    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenNoHeadersWereStubbed_ButHeadersWereSetToAssert()
            throws Exception {
    ...
    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenNoQueryParamsWereStubbed_ButQueryParamsWereSetToAssert()
            throws Exception {
        ...
        final StubRequest expectedRequest =
                builder.withUrl(url).withMethodGet().withMethodHead().build();
    ...
    @Test
    public void stubbedRequestNotEqualsAssertingRequest_WhenQueryParamsWereStubbed_ButNoQueryParamsWereSetToAssert()
            throws Exception {
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenQueryParamRegexIsMatching() throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url)
                ...
                .withMethodHead()
                .withQuery(paramOne, paramOneValue)
                .withQuery(paramTwo, paramTwoRegex)
                .build();
        ...
        final StubRequest assertingRequest = builder.withUrl(url)
                ...
                .withMethodHead()
                .withQuery(paramOne, paramOneValue)
                .withQuery(paramTwo, paramTwoAssertingValue)
                .build();
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenHeaderRegexIsMatching() throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url)
                ...
                .withHeader(headerTwo, headerTwoRegex)
                .build();
        ...
        final StubRequest assertingRequest = builder.withUrl(url)
                ...
                .withMethodHead()
                .withHeader(headerOne, headerOneValue)
                .withHeader(headerTwo, headerTwoAssertingValue)
                .build();
    ...
    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenPostRegexMatchingAnyPostWithoutNewLineCharacter()
            throws Exception {
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenPostRegexMatchingPostWithSystemLineChar() throws Exception {
        ...
        final String postAssertingValue =
                "Here's the story of a lovely lady," + BR + "Who was bringing up three very lovely girls."
                        + BR + "All of them had hair of gold, like their mother,"
                        + BR + "The youngest one in curls."
                        + BR + "Here's the story, of a man named Brady,"
                        + BR + "Who was busy with three boys of his own."
                        + BR + "They were four men, living all together,"
                        + BR + "Yet they were all alone.";
    ...
    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenPostRegexMatchingPostWithCarriageReturnChar()
            throws Exception {

        final String postRegex = ".*";

        final String postAssertingValue =
                "Here's the story of a lovely lady,\r" + "Who was bringing up three very lovely girls.\r"
    ...
    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenPostRegexMatchingPostWithCarriageReturnLinefeedChars()
            throws Exception {
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenPlainPostRegexStubbedAndPlainTextPosted() throws Exception {
        ...
        final StubRequest expectedRequest =
                builder.withUrl(url).withMethodPost().withPost(postRegex).build();
    ...
    public void shouldComputeRegexPatterns() throws Exception {
        ...
        final StubRequest stubRequest = builder.withUrl(url)
                .withMethodPost()
                .withApplicationJsonContentType()
                .withPost(post)
                .build();
    ...
    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenPostRegexMatchingSubsectionOfMultiLineJsonPost()
            throws Exception {

        final String postRegex = ".*(\"id\": \"123\").*";

        final String postAssertingValue = "{" + "   \"products\": ["
                + "      {"
                + "      \"id\": \"123\","
                + "      },"
                + "      {"
    ...
    @Test
    public void
            stubbedRequestEqualsAssertingRequest_WhenThereLargeSetupOfStubbedProperties_ButNotAllHeadersSetToAssert()
                    throws Exception {
    ...
    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenRegexifiedUrlDoesNotBeginWithRegexSign_ItsNotProcessedAsRegex()
            throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url).withMethodGet().build();
        final StubRequest assertingRequest =
                builder.withUrl("/some/products/account/").withMethodGet().build();

        assertThat(assertingRequest).isEqualTo(expectedRequest);
    }

    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenRegexifiedUrlBeginsWithRegexSign_ItsProcessedAsRegex()
            throws Exception {
    ...
    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenUrlPartiallyRegexified_ButGoodAssertionUrlConfigured()
            throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url).withMethodGet().build();
        final StubRequest assertingRequest =
                builder.withUrl("/products/12345/").withMethodGet().build();

        assertThat(assertingRequest).isEqualTo(expectedRequest);
    }

    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenUrlRegexified_ButGoodAssertionUrlConfigured()
            throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url).withMethodGet().build();
        final StubRequest assertingRequest =
                builder.withUrl("/abc/12345/").withMethodGet().build();

        assertThat(assertingRequest).isEqualTo(expectedRequest);
    }

    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenUrlConditionallyRegexified_ButGoodAssertionUrlConfigured()
            throws Exception {
    ...
    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenUrlConditionallyRegexified_ButGoodAssertionUrlConfigured_v2()
            throws Exception {
        ...
        final List<StubRequest> assertingRequests = new LinkedList<StubRequest>() {
            {
                add(builder.withUrl("/account/user/session/d41d8cd98f00b204e9800998ecf8427e")
                        .withMethodGet()
                        .build());
                add(builder.withUrl("/account/user/session/d41d8cd98f00b204e9800998ecf8427e/")
                        .withMethodGet()
                        .build());
                add(builder.withUrl("/profile/user/session/d41d8cd98f00b204e9800998ecf8427e")
                        .withMethodGet()
                        .build());
                add(builder.withUrl("/profile/user/session/d41d8cd98f00b204e9800998ecf8427e/")
                        .withMethodGet()
    ...
    @Test
    public void stubbedRequestNotEqualsAssertingRequest_WhenUrlRegexified_ButBadAssertionUrlConfigured()
            throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url).withMethodGet().build();
        final StubRequest assertingRequest =
                builder.withUrl("/abcm/12345/").withMethodGet().build();

        assertThat(assertingRequest).isNotEqualTo(expectedRequest);
    }

    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenComplexUrlRegexified_ButGoodAssertionUrlConfigured()
            throws Exception {
        ...
        final List<StubRequest> assertingRequests = new LinkedList<StubRequest>() {
            {
                add(builder.withUrl("/abc-efg/12/KM/jhgjkhg234234l2")
                        .withMethodGet()
                        .build());
    ...
    @Test
    public void stubbedRequestNotEqualsAssertingRequest_WhenComplexUrlRegexified_ButBadAssertionUrlConfigured()
            throws Exception {
        ...
        final List<StubRequest> assertingRequests = new LinkedList<StubRequest>() {
            {
                add(builder.withUrl("/abca-efg/12/KM/jhgjkhg234234l2")
                        .withMethodGet()
                        .build());
    ...
    public void stubbedRequestShouldReturnEmptyRegexGroup_WhenValidRegexHasNoMatcherGroups() throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url).withMethodGet().build();
        final StubRequest assertingRequest = builder.withUrl("/abc-efg/12/KM/jhgjkhg234234l2")
                .withMethodGet()
                .build();
    ...
    public void stubbedRequestShouldReturnOneRegexGroup_WhenValidRegexHasMatcherGroups() throws Exception {
        ...
        assertThat(assertingRequest.getRegexGroups().toString())
                .isEqualTo("{url.0=/abc-efg/12/KM/jhgjkhg234234l2, url.1=jhgjkhg234234l2}");
    }
    ...
    public void stubbedRequestShouldReturnMultipleRegexGroups_WhenValidRegexHasMatcherGroups() throws Exception {
        ...
        assertThat(assertingRequest.getRegexGroups().toString())
                .isEqualTo("{url.0=/abc-efg/12/KM/jhgjkhg234234l2, url.1=abc-efg, url.2=jhgjkhg234234l2}");
    }

    @Test
    public void stubbedRequestShouldReturnMultipleRegexGroups_WhenRegexHasCapturingGroupWhichIsAlsoFullRegex()
            throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url).withMethodGet().build();
        final StubRequest assertingRequest =
                builder.withUrl("abc").withMethodGet().build();
    ...
    @Test
    public void stubbedRequestShouldReturnMultipleRegexGroups_WhenValidRegexHasCapturingGroupsInMultipleProperties()
            throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url)
                .withMethodGet()
                .withQuery("paramOne", "(\\d{1,})")
                .build();
        final StubRequest assertingRequest = builder.withUrl("/abc-efg/12/KM/jhgjkhg234234l2")
                .withQuery("paramOne", "12345")
                .withMethodGet()
                .build();
        ...
        assertThat(assertingRequest.getRegexGroups().toString())
                .isEqualTo(
                        "{query.paramOne.0=12345, query.paramOne.1=12345, url.0=/abc-efg/12/KM/jhgjkhg234234l2, url.1=abc-efg, url.2=jhgjkhg234234l2}");
    }

    @Test
    public void stubbedRequestShouldReturnMultipleRegexGroups_WhenValidRegexHasCapturingGroupsInQuery()
            throws Exception {
        ...
        final StubRequest expectedRequest = builder.withUrl(url)
                .withMethodGet()
                .withQuery("paramOne", "(\\d{1,})")
                .withQuery("paramTwo", "([A-Z]{5})")
                .build();
        final StubRequest assertingRequest = builder.withUrl("/abc-efg/12/KM/jhgjkhg234234l2")
                .withQuery("paramOne", "12345")
                .withQuery("paramTwo", "ABCDE")
                .withMethodGet()
                .build();
        ...
        assertThat(assertingRequest.getRegexGroups().toString())
                .isEqualTo(
                        "{query.paramOne.0=12345, query.paramOne.1=12345, query.paramTwo.0=ABCDE, query.paramTwo.1=ABCDE, url.0=/abc-efg/12/KM/jhgjkhg234234l2, url.1=abc-efg, url.2=jhgjkhg234234l2}");
    }
    ...
    public void stubbedRequestShouldReturnMultipleRegexGroups_WhenValidRegexHasOneSubCapturingGroup() throws Exception {
        ...
        assertThat(assertingRequest.getRegexGroups().toString())
                .isEqualTo("{url.0=/abc-efg/jhgjkhg234234l2, url.1=abc-efg, url.2=efg, url.3=jhgjkhg234234l2}");
    }

    @Test
    public void stubbedRequestShouldReturnMultipleRegexGroups_WhenValidRegexHasMultipleSubCapturingGroups()
            throws Exception {
        ...
        assertThat(assertingRequest.getRegexGroups().toString())
                .isEqualTo(
                        "{url.0=/abc-efg/jhgjkhg234234l2, url.1=abc-efg, url.2=abc, url.3=efg, url.4=jhgjkhg234234l2}");
    }

    @Test
    public void stubbedRequestEqualsAssertingRequest_WhenUrlRegexifiedDoesNotAccommodateForQueryString()
            throws Exception {
    ...
    public void stubbedRequestNotEqualsAssertingRequest_WhenUrlRegexifiedHasQueryString() throws Exception {
        ...
        final String url =
                "^/[a-z]{3}-[a-z]{3}/[0-9]{2}/[A-Z]{2}/[a-z0-9]+\\?paramOne=[a-zA-Z]{8}&paramTwo=[a-zA-Z]{8}";
        ...
        final List<StubRequest> assertingRequests = new LinkedList<StubRequest>() {
            {
                add(builder.withUrl("/atom/feed")
                        ...
                        .withQuery("max-results", "0")
                        .build());
                add(builder.withUrl("/atom/feed")
                        .withMethodGet()
                        .withQuery("min-results", "1")
                        .withQuery("max-results", "5")
                        .build());
                add(builder.withUrl("/atom/feed")
                        .withMethodGet()
                        .withQuery("min-results", "4654645756756")
                        .withQuery("max-results", "5675675686786786785675464564564")
                        .build());
            }
        };
    ...
    @Test
    public void
            stubbedRequestNotEqualsAssertingRequest_WhenUrlRegexifiedAccomodatesForQueryString_ButBadAssertionUrlConfigured()
                    throws Exception {
    ...
    public void shouldFindTwoHashCodesEqual_WhenTwoRequestAreTheSame() throws Exception {
        ...
        final StubRequest requestOne = builder.withUrl(url)
                .withMethodGet()
                .withMethodPost()
                .withMethodPut()
                .withPost(postBody)
        ...
        final StubRequest requestTwo = builder.withUrl(url)
                .withMethodGet()
                .withMethodPost()
                .withMethodPut()
                .withPost(postBody)
    ...
    public void shouldMatchExpectedToStringOutput_WhenActualRequestHasTheSameOutput() throws Exception {
        ...
        final StubRequest actualRequest = builder.withUrl("/invoice/123")
                .withMethodGet()
                .withMethodPost()
                .withMethodPut()
        ...
        final String expectedToStringOutput = "StubRequest{" + "url=/invoice/123, "
                + "method=[GET, POST, PUT], "
    ...
    public void shouldMatchExpectedToStringOutput_WhenActualRequestHasAllNullFields() throws Exception {
        ...
        final StubRequest actualRequest =
                builder.withUrl(null).withMethod(null).withPost(null).build();

        final String expectedToStringOutput =
                "StubRequest{" + "url=null, " + "method=[], " + "query={}, " + "headers={}}";
    ...
    public void shouldFindPostNotStubbed_WhenPostNullAndMethodGet() throws Exception {
        final StubRequest stubRequest =
                builder.withUrl("fssefewf").withMethod("GET").withPost(null).build();
    ...
    public void shouldFindPostNotStubbed_WhenPostStubbedAndMethodGet() throws Exception {
        final StubRequest stubRequest = builder.withUrl("fssefewf")
                .withMethod("GET")
                .withPost("stubbed")
                .build();
    ...
    public void shouldFindPostNotStubbed_WhenPostNullAndMethodPut() throws Exception {
        final StubRequest stubRequest =
                builder.withUrl("fssefewf").withMethod("PUT").withPost(null).build();
    ...
    public void shouldFindPostNotStubbed_WhenPostEmptyAndMethodPut() throws Exception {
        final StubRequest stubRequest =
                builder.withUrl("fssefewf").withMethod("PUT").withPost("").build();
    ...
    public void shouldFindRequestBodyStubbed_WhenFileStubbedAndMethodPatch() throws Exception {
        final StubRequest stubRequest = builder.withUrl("fssefewf")
                .withMethod("PATCH")
                .withFile(FileUtils.tempFileFromString("hello"))
                .build();
    ...
    public void shouldFindRequestBodyNotStubbed_WhenJustMethodPatch() throws Exception {
        final StubRequest stubRequest =
                builder.withUrl("fssefewf").withMethod("PATCH").build();
    ...
    public void shouldFindPostNotStubbed_WhenPostNullAndMethodPost() throws Exception {
        final StubRequest stubRequest =
                builder.withUrl("fssefewf").withMethod("POST").withPost(null).build();
    ...
    public void shouldFindPostNotStubbed_WhenPostEmptyAndMethodPost() throws Exception {
        final StubRequest stubRequest =
                builder.withUrl("fssefewf").withMethod("POST").withPost("").build();
