...
public class YamlBuilderTest {
    ...
    public void shouldBuildStubbedResponseWithSequenceResponses() throws Exception {
        final String expectedYaml = "-  description: Hello!" + BR + "   uuid: abc-123-def-456"
                + BR + "   request:"
                + BR + "      method: [PUT]"
                + BR + "      url: /invoice"
                + BR + ""
                ...
                + BR + "         headers: "
                + BR + "            content-type: application/json"
                + BR + "         body: Still going strong!"
                + BR + ""
                + BR + "      -  status: 500"
                + BR + "         headers: "
                + BR + "            content-type: application/json"
                + BR + "         body: OMFG!!!"
                + BR + "         file: ../../response.json";
    ...
    public void shouldBuildStubbedResponseWithSequenceResponsesFoldedBodyAndFile() throws Exception {
        final String expectedYaml = "-  request:" + BR + "      method: [PUT]"
                + BR + "      url: /invoice"
                + BR + ""
                + BR + "   response:"
                + BR + "      -  status: 200"
                ...
                + BR + "         headers: "
                + BR + "            content-type: application/json"
                + BR + "         file: ../path/to/error.file";

        final YamlBuilder YamlBuilder = new YamlBuilder();
        final String actualYaml = YamlBuilder.newStubbedRequest()
                .withMethodPut()
                .withUrl("/invoice")
                .newStubbedResponse()
                .withSequenceResponseStatus("200")
    ...
    public void shouldBuildStubbedRequestWithMultipleMethods() throws Exception {
        final String expectedYaml = "-  request:" + BR + "      method: [HEAD, GET, PUT]"
                + BR + "      url: /invoice"
                + BR + ""
                + BR + "   response:"
                + BR + "      status: 200"
    ...
    public void shouldBuildStubbedRequestWithStubbedResponse() throws Exception {
        final String expectedYaml = "-  request:" + BR + "      query:"
                + BR + "         status: active"
                + BR + "         type: full"
                + BR + "      method: [GET]"
                + BR + "      url: /invoice"
                ...
                + BR + "         pragma: no-cache"
                + BR + "      status: 200"
                + BR + "      file: ../json/systemtest-body-response-as-file.json";
        ...
        final String actualYaml = YamlBuilder.newStubbedRequest()
                ...
                .withStatus("200")
                .withFile("../json/systemtest-body-response-as-file.json")
                .build();
    ...
    public void shouldBuildStubbedRequestWithMultilineStubbedResponse() throws Exception {
        ...
        final String expectedYaml = "-  request:" + BR + "      method: [PUT]"
                ...
                + BR + "         content-type: application/json"
                + BR + "      post: >"
                + BR + "         {\"name\": \"milk\", \"description\": \"full\", \"department\": \"savoury\"}"
                + BR + ""
                + BR + "   response:"
                + BR + "      headers:"
                + BR + "         content-type: application/json"
        ...
        final String actualYaml = YamlBuilder.newStubbedRequest()
                ...
                .withHeaders("pragma", "no-cache")
                .withStatus("200")
                .withFoldedBody("{\"id\": \"123\", \"status\": \"updated\"}")
                .build();
    ...
    public void shouldBuildStubbedRequestWithStubbedResponseWhenBothHaveManyHeaders() throws Exception {
        final String expectedYaml = "-  request:" + BR + "      headers:"
                + BR + "         content-type: application/json"
                + BR + "         content-language: US-en"
                + BR + "         content-encoding: gzip"
                + BR + "         content-length: 30"
                + BR + "         "
                + BASIC.asYAMLProp() + ": bob:secret" + BR + "         "
                + BEARER.asYAMLProp() + ": jkRUTBUjghbjtUGT==" + BR + "         "
                + CUSTOM.asYAMLProp() + ": Custom jkRUTBUjghbjtUGT==" + BR + "      method: [GET]"
                + BR + "      url: /invoice"
                + BR + ""
                + BR + "   response:"
                + BR + "      headers:"
        ...
        final String actualYaml = YamlBuilder.newStubbedRequest()
                ...
                .withHeaderLocation("/invoice/exit")
                .build();
    ...
    public void shouldBuildStubbedProxyConfig() throws Exception {
        final String expectedYaml = "-  proxy-config:" + BR + "      description: very-interesting-description"
                + BR + "      uuid: very-unique-name"
                + BR + "      strategy: as-is"
                + BR + "      headers:"
                + BR + "         keyOne: valueOne"
                + BR + "         keyTwo: valueTwo"
                + BR + "      properties:"
                + BR + "         endpoint: http://google.com"
                + BR + "         key: value";

        final YamlBuilder YamlBuilder = new YamlBuilder();
        final String actualYaml = YamlBuilder.newStubbedProxyConfig()
