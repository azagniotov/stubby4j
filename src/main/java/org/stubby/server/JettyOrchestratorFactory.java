...
public final class JettyOrchestratorFactory {
   ...
   public static JettyOrchestrator getInstance(final String yamlConfigFilename) throws IOException {
      if (jettyOrchestrator == null) {
         ...
         repository.init();
         jettyOrchestrator = new JettyOrchestrator(new Server(), repository);
      }
