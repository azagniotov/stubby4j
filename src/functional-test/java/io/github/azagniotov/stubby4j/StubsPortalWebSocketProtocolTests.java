...
public class StubsPortalWebSocketProtocolTests {
    ...
    public void nativeJettyWebSocketsOnSsl() throws Exception {
        ...
        try {
            ...
            final StubsClientWebSocket socket = new StubsClientWebSocket(receivedMessages, countDownLatch);

            // Attempt Connect
            final Future<Session> sessionFuture = client.connect(socket, WEBSOCKET_SSL_EVENTS_URL);
    ...
    public static class StubsClientWebSocket {
        ...
        public StubsClientWebSocket(final Set<String> receivedMessages, final CountDownLatch countDownLatch) {
